...
<div class="navbar">
    <div>
        ...
        <a href="book-lending-returning.php" data-lang-key="book-lending-returning.php" class="<?php echo ($current_page == 'book-lending-returning.php') ? 'active' : ''; ?>">QUẢN LÝ MƯỢN - TRẢ SÁCH</a>
